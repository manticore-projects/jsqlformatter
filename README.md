...
, checksum: [SHA-1](https://repo1.maven.org/maven2/com/manticore-projects/jsqlformatter/jsqlformatter/0.1.3/jsqlformatter-0.1.3.jar.sha1))
	- Linux: [JSQLFormatter](https://github.com/manticore-projects/jsqlformatter/releases/download/0.1.3/JSQLFormatter) (2.8 MB,ELF 64-bit LSB pie executable, statically linked)
	- Windows: [JSQLFormatter.exe](https://github.com/manticore-projects/jsqlformatter/releases/download/0.1.3/JSQLFormatter.exe) (2.8 MB, PE32+ executable (console))
	- MacOS is planned
