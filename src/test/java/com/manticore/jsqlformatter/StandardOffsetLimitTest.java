...
public class StandardOffsetLimitTest extends StandardSelectTest {

  @Parameters(name = "{index}: {0}")
  public static Iterable<Object[]> getSqlMap() {
    return getSqlMap(StandardOffsetLimitTest.class);
  }

  public StandardOffsetLimitTest(String input, String expected) {
