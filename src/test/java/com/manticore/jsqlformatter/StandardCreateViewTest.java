...
public class StandardCreateViewTest extends StandardSelectTest {

  @Parameters(name = "{index}: {0}")
  public static Iterable<Object[]> getSqlMap() {
    return getSqlMap(StandardCreateViewTest.class);
  }

  public StandardCreateViewTest(String input, String expected) {
