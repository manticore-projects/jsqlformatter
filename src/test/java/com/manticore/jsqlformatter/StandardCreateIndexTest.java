...
public class StandardCreateIndexTest extends StandardSelectTest {

  @Parameters(name = "{index}: {0}")
  public static Iterable<Object[]> getSqlMap() {
    return getSqlMap(StandardCreateIndexTest.class);
  }

  public StandardCreateIndexTest(String input, String expected) {
