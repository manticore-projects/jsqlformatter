...
public class StandardAlterTest extends StandardSelectTest {

  @Parameters(name = "{index}: {0}")
  public static Iterable<Object[]> getSqlMap() {
    return getSqlMap(StandardAlterTest.class);
  }

  public StandardAlterTest(String input, String expected) {
