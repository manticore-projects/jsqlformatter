...
public class StandardDeleteTest extends StandardSelectTest {

  @Parameters(name = "{index}: {0}")
  public static Iterable<Object[]> getSqlMap() {
    return getSqlMap(StandardDeleteTest.class);
  }

  public StandardDeleteTest(String input, String expected) {
