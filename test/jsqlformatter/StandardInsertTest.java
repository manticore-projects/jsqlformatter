...
public class StandardInsertTest extends StandardSelectTest {
  
  @Parameters(name = "{index}: {0}")
  public static Iterable<Object[]> getSqlMap() {
    return getSqlMap(StandardInsertTest.class);
  }

  public StandardInsertTest(String input, String expected) {
