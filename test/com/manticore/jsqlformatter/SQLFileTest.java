...
public class SQLFileTest {
  ...
  public static Iterable<Object[]> getSqlMap(Class<? extends SQLFileTest> clasz) {
  ...
  public static Iterable<Object[]> getSqlMap() {
    return getSqlMap(SQLFileTest.class);
  }

  protected String input;
  protected String expected;

  public SQLFileTest(String input, String expected) {
    this.input = input;
