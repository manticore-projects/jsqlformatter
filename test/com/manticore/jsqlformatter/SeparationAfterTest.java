...
public class SeparationAfterTest extends StandardSelectTest {
  
  @Parameters(name = "{index}: {0}")
  public static Iterable<Object[]> getSqlMap() {
    return getSqlMap(SeparationAfterTest.class);
  }

  public SeparationAfterTest(String input, String expected) {
