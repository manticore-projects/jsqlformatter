...
public class StandardTruncateTest extends StandardSelectTest {

  @Parameters(name = "{index}: {0}")
  public static Iterable<Object[]> getSqlMap() {
    return getSqlMap(StandardTruncateTest.class);
  }

  public StandardTruncateTest(String input, String expected) {
